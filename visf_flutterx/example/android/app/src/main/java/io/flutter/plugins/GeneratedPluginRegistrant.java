...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new visf.flutterx.visf_flutterx.VisfFlutterxPlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin visf_flutterx, visf.flutterx.visf_flutterx.VisfFlutterxPlugin", e);
    }
    try {
